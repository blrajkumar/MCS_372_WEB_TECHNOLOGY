...
if(!empty($_POST["submit"])) {
    $query = "UPDATE toy set name = '".$_POST["name"]."', age = '".$_POST["age"]."', gender = '".$_POST["gender"]."', course = '".$_POST["course"]."', address = '".$_POST["address"]."' WHERE  id=".$_GET["id"];
...
<input type="text" name="age" id="age" class="demoInputBox" value="<?php echo $result[0]["age"]; ?>">
</div>
<div>
<label>gender</label> 
<span id="gender-info" class="info"></span><br/>
<input type="text" name="gender" id="gender" class="demoInputBox" value="<?php echo $result[0]["gender"]; ?>">
</div>
<div>
<label>course</label> 
<span id="course-info" class="info"></span><br/>
<input type="text" name="course" id="course" class="demoInputBox" value="<?php echo $result[0]["course"]; ?>">
</div>
<div>
<label>address</label> 
<span id="address-info" class="info"></span><br/>
<input type="text" name="address" id="address" class="demoInputBox" value="<?php echo $result[0]["address"]; ?>">
</div>
<div>
